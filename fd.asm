...
;      TASM -t80 -b -g3 -fFF -dFDPLT=PLT_DIO FD.ASM FD.COM
;
; TODO:
...
#ENDIF
#IF ((PLATFORM == PLT_DIO) | (PLATFORM == PLT_DIO3) | (PLATFORM == PLT_ZETA))
...
FDC_DMA		.EQU	03CH		; NOT USED BY ZETA SBC V2
#ENDIF
;
;===============================================================================
...
MDB_DOR		.DB	000H		; OPERATIONS REGISTER VALUE FOR MEDIA
...
MV_LAT	.TEXT	                        "XX"
	.TEXT	                          "      (M)OTOR:"
MV_MOT	.TEXT	                                        "XXX"
#IF ((PLATFORM == PLT_ZETA) | (PLATFORM == PLT_DIO3) | (PLATFORM == PLT_DIDE))
	.TEXT	                                           "     FDC RESET (Z)"
#ENDIF
...
#IF (PLATFORM == PLT_DIO)
	...
	XOR	00000010B
#ENDIF
#IF ((PLATFORM == PLT_ZETA) | (PLATFORM == PLT_DIO3))
	AND	00000010B
#ENDIF
#IF ((PLATFORM == PLT_DIDE) | (PLATFORM == PLT_N8) | (PLATFORM == PLT_ZETA2))
	AND	11110000B
#ENDIF
	LD	DE,STR_ON
	JP	NZ,FM_DRAW1
...
;
FXRX:
	LD	BC,1000H		; BC IS LOOP COUNTER, 4096 ITERATIONS OF 25ms
FXRX1:
	CALL	FOP_DELAY
...
;
#IF (PLATFORM == PLT_DIO)
DOR_BR250	.EQU	10100110B	; 250KBPS
DOR_BR500	.EQU	11010010B	; 500KBPS
;
DOR_INIT	.EQU	DOR_BR250
#ENDIF
;
...
;
#IF ((PLATFORM == PLT_ZETA) | (PLATFORM == PLT_DIO3))
DOR_BR250	.EQU	11100100B	; 250KBPS
DOR_BR500	.EQU	10100000B	; 500KBPS
;
DOR_INIT	.EQU	DOR_BR250
#ENDIF
;
