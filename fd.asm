...
FCB_PC720	.DB	009H		; SECTOR COUNT
		...
		.DB	DOR_250		; OPERATIONS REGISTER VALUE
		.DB	DCR_250		; CONTROL REGISTER VALUE
...
FCB_PC144	.DB	012H		; SECTOR COUNT
		...
		.DB	DOR_500		; OPERATIONS REGISTER VALUE
		.DB	DCR_500		; CONTROL REGISTER VALUE
...
;
#IF (PLATFORM == PLT_DISKIO)
DOR_250		.EQU	10100110B	; 250KBPS
DOR_500		.EQU	11010010B	; 500KBPS

DOR_INIT	.EQU	DOR_250
#ENDIF
;
...
;
#IF ((PLATFORM == PLT_ZETA) | (PLATFORM == PLT_DISKIO3))
DOR_250		.EQU	11100100B	; 250KBPS
DOR_500		.EQU	10100000B	; 500KBPS
...
DOR_250		.EQU	DOR_INIT
DOR_500		.EQU	DOR_INIT
#ENDIF
;
; DCR (ONLY EXISTS ON DIDE AND N8)
;
DCR_250		.EQU	01H		; 250KBPS
DCR_500		.EQU	00H		; 500KBPS
;
;===============================================================================
