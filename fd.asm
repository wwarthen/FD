...
DOR_PC360	.EQU	11100110B	; DC/RDY=HI, /REDWC=LO=DD, PRECOMP=001, MINI=HI=ON, MOTOR=HI=OFF, TC=LOW
DOR_PC120	.EQU	11100010B	; DC/RDY=HI, /REDWC=LO=DD, PRECOMP=001, MINI=LO=OFF, MOTOR=HI=OFF, TC=LOW
DOR_PC111	.EQU	11100010B	; DC/RDY=HI, /REDWC=LO=DD, PRECOMP=001, MINI=LO=OFF, MOTOR=HI=OFF, TC=LOW
#ENDIF
#IF ((PLATFORM == PLT_ZETA) | (PLATFORM == PLT_DISKIO3))
...
DOR_PC120	.EQU	10100000B	; DC/RDY=HI, /REDWC=HI=DD, PRECOMP=001, MINI=LO=OFF, MOTOR=LO=OFF, TC=LOW
DOR_PC111	.EQU	10100000B	; DC/RDY=HI, /REDWC=HI=DD, PRECOMP=001, MINI=LO=OFF, MOTOR=LO=OFF, TC=LOW
#ENDIF
#IF ((PLATFORM == PLT_DIDE) | (PLATFORM == PLT_N8))
